...
didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer
    ...
    if (connection == videoConnection) {
        if (self.delegate &&
            ...
            [self.delegate captureOutput:captureOutput
...
- (BOOL)setupCaptureSession:(AVCaptureVideoOrientation)videoOrientation {
    ...
    [[AVCaptureDeviceInput alloc] initWithDevice:videoDevice error:nil];
    if ([captureSession canAddInput:videoIn]) [captureSession addInput:videoIn];
    ...
    if (videoConnection.supportsVideoMirroring) { [videoConnection setVideoMirrored:TRUE]; }
