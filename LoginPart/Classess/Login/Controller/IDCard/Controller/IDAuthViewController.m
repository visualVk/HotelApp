...
- (void)viewDidLoad {
    ...
    self.startButton.tintColor = UIColor.qd_backgroundColor;
    self.startButton.backgroundColor = UIColor.qd_tintColor;
...
- (IBAction)shoot:(UIButton *)sender {
    ...
    NSArray *cons =  self.navigationController.viewControllers;
    AVCaptureVC.beforeController = cons[cons.count - 2];
    AVCaptureVC.IDCardBlock = self.IDCardBlock;
