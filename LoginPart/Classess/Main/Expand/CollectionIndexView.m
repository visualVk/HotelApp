 ...
 */
@property (assign, nonatomic) Boolean indexSelected;
...
/** Handles logic for determining which label is under a given touch point, and sets `currentIndex`
 * accordingly.
...
- (UIView *)touchStatusView {
  ...
  //  _touchStatusView.backgroundColor     = UIColor.clearColor;
